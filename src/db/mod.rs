//! 数据访问层总入口。
//!
//! 统一声明各表访问模块，并 re-export 常用实体与 CRUD 函数。
...
pub use device::{
    ...
    find_devices_by_system, find_devices_page, update_device, update_device_health_error,
...
// 导出连接池管理函数
pub use pool::{DbPool, get_pool, init_pool, is_pool_initialized, try_get_pool};
